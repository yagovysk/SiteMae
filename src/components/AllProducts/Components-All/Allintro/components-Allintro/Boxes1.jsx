...
import { Boxes5 } from './Boxes5';
import { Boxes6 } from './Boxes6';
              ...
              <div className="sabor-selecionado-responsive">
                ...
                <article>
                  ...
                  <p className="paragraph">
                    {conteudos[selectedSabor].descricao}
                  </p>
                  ...
                  <div className="container-alert">
                    <div className="alert">
                      ...
                      <p>
                        Saiba como funciona nossos prazos de entrega e processos
                        de encomenda na seção abaixo "Informações Importantes".
                      </p>
                    </div>
                  </div>
                </article>
                    ...
                    <div className="additional-content1">
                      {
                        <div className="container-additional1">
                          <article className="article-add">
                            <h1>Descrição</h1>
                            <p>
                              Bolo com massa de pão de ló de chocolate, recheado
                              com brigadeiro Ofner, coberto com creme trufado,
                              finalizado com drágeas coloridas, pastilhas de
                              chocolate ao leite com drageados coloridos e placa
                              de chocolate ao leite com logo Ofner. Delicie-se
                              com o nosso bolo de chocolate, uma obra-prima
                              confeccionada com o mais puro cacau e ingredientes
                              selecionados. Cada camada é um convite
                              irresistível ao prazer, com o sabor intenso do
                              chocolate harmonizado com a maciez da massa.
                            </p>
                            <h1>Ingredientes</h1>
                            <p>
                              Doce de leite (leite reconstituído, soro de leite
                              reconstituído, açúcar, glucose, bicarbonato de
                              sódio, conservador sorbato de potássio,
                              estabilizante citrato de sódio e lactase),
                              chocolate meio amargo (pasta de cacau, açúcar,
                              manteiga de cacau, emulsificante: lecitina de
                              soja, emulsificante: ésteres de ácido ricinoleico
                              interesterificado com poliglicerol, aromatizante),
                              creme de leite, ovo, açúcar, chocolate ao leite
                              (açúcar, leite em pó integral, manteiga de cacau,
                              pasta de cacau, emulsificante: lecitina de soja,
                              emulsificante, ésteres de ácido ricinoleico
                              interesterificado com poliglicerol, aromatizante),
                              confeitos coloridos (açúcar, xarope de glicose,
                              amido de milho). CONTÉM GLÚTEN. CONTÉM LACTOSE.
                              ALÉRGICOS: CONTÉM LEITE, OVO E DERIVADOS DE TRIGO,
                              LEITE E SOJA. PODE CONTER AMENDOIM, AMÊNDOA,
                              AVELÃ, AVEIA, CASTANHA DE CAJU, MACADÂMIA, NOZES,
                              PISTACHE E DERIVADO DE CEVADA.
                            </p>
                          </article>
                        ...
                        <div className="container-additional2">
                          <article className="article-add">
                            ...
                            <p>
                              ...
                              podem variar de acordo com a complexidade do
                              pedido e a demanda atual. Para assegurar que sua
                              encomenda seja entregue perfeitamente, solicitamos
                              que considere os seguintes prazos estimados:
                            </p>
                            <h1>🎂 Bolos e Tortas Artesanais</h1>
                            <p>
                              Nossos cupcakes e brigadeiros são feitos com
                              atenção minuciosa. Por isso, pedimos um prazo de
                              [Y dias] para garantir que cada peça seja feita
                              com perfeição.
                            </p>
                            <h1>🍬 Cestas e Kits Personalizados</h1>
                            <p>
                              Para cestas e kits sob medida, recomendamos uma
                              antecedência de [Z dias] para que possamos
                              selecionar os melhores ingredientes/produtos e
                              montar sua cesta ou kit com alta qualidade.
                            </p>
                            <h1>✨ Personalização Exclusiva</h1>
                            <p>
                              Lembre-se de que produtos personalizados podem
                              exigir um tempo extra para aperfeiçoar os detalhes
                              que tornarão sua encomenda verdadeiramente
                              especial.
                            </p>
                            <h1>📝 Pedidos Antecipados</h1>
                            <p>
                              Ao fazer sua encomenda, planeje com antecedência
                              para garantir que possamos atender às suas
                              expectativas e entregar no prazo desejado.
                              Agradecemos por escolher a Laços & Confeitos para
                              tornar seus momentos ainda mais doces e especiais.
                              Estamos ansiosos para criar algo incrível para
                              você! Para detalhes mais precisos sobre os prazos
                              de entrega e disponibilidade, entre em contato
                              conosco. Estamos aqui para tornar sua experiência
                              conosco memorável.
                            </p>
                          </article>
                          <div className="other-add">
