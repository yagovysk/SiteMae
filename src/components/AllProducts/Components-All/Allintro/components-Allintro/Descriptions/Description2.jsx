    ...
    <section className="section-description">
      <div className="container-description">
        ...
        <article className="article-description">
          ...
          <h2>
            Maravilhoso bolo caseiro de morango, bem fofinho, coberto com a
            nossa cobertura de morango cremosa, finalizado com geleia gourmet.
            Com um toque final de geleia de morango gourmet que acrescenta uma
