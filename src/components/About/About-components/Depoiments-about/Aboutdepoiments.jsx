...
export function Aboutdepoiments() {
  ...
  return (
    <div className="DepoimentsAbout-container">
      <h1>Conheça Quem Confia na Gente </h1>
      <img src={linha} alt="" />
      <Carousel
        className="DepoimentsAbout-carousel"
        showArrows={true}
        showStatus={false}
        showIndicators={true}
        swipeable={true}
      ...
      >
        {testimonials.map((testimonial) => (
          <div key={testimonial.id} className="testimonialAbout-slide">
            <div>
              <img
            ...
            <div className="stars1About">
              <img src={testimonial.star} alt="" />
            </div>
            <p className="testimonialAbout-text">{testimonial.text}</p>
            <p className="testimonialAbout-author"> {testimonial.author}</p>
          </div>
        ))}
      </Carousel>
    </div>
